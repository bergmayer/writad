...
public final class TreeSitterLanguage {
    ...
    /// Prepares the language to be used by EditorEngine. This can be called on a background queue to have the language prepared before it is needed.
    ///
    /// If the language haven't been explicitly prepared, EditorEngine will automatically do it before it's used.
    public func prepare() {
        if !isPrepared {
